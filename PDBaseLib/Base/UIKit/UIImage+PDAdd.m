...
+ (UIImage *)imageWithPDF:(id)dataOrPath {
    return [self _pd_imageWithPDF:dataOrPath resize:NO size:CGSizeZero];
}

+ (UIImage *)imageWithPDF:(id)dataOrPath size:(CGSize)size {
    return [self _pd_imageWithPDF:dataOrPath resize:YES size:size];
}
...
+ (UIImage *)_pd_imageWithPDF:(id)dataOrPath resize:(BOOL)resize size:(CGSize)size {
...
- (void)drawInRect:(CGRect)rect withContentMode:(UIViewContentMode)contentMode clipsToBounds:(BOOL)clips{
    CGRect drawRect = PDCGRectFitWithContentMode(rect, self.size, contentMode);
...
- (UIImage *)_pd_flipHorizontal:(BOOL)horizontal vertical:(BOOL)vertical {
...
- (UIImage *)imageByRotate180 {
    return [self _pd_flipHorizontal:YES vertical:YES];
}

- (UIImage *)imageByFlipVertical {
    return [self _pd_flipHorizontal:NO vertical:YES];
}

- (UIImage *)imageByFlipHorizontal {
    return [self _pd_flipHorizontal:YES vertical:NO];
}
